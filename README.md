...
- [GitHub]() (👨‍💻 20 · 📦 9):
	...
	```
- [PyPi](https://pypi.org/project/pyrobosim) (📥 810 / month):
	```
...
<details><summary><b><a href="https://www.flightgear.org/">Flightgear</a></b> (🥇8 ·  ⭐ 76 · 💤) - FlightGear open-source flight simulator [flightgear.org](https://www.flightgear.org). <code><a href="https://tldrlegal.com/search?q=gnu-gpl2">gnu-gpl2</a></code></summary>

- [GitLab](https://gitlab.com/flightgear/flightgear) (🔀 56 · 📋 610 - 38% open · ⏱️ 04.03.2015):
...
- [GitHub]() (👨‍💻 600 · 📦 23K):
	...
	```
- [PyPi](https://pypi.org/project/gymnasium) (📥 7.7M / month):
	```
...
- [GitHub]() (👨‍💻 54):
	...
	```
- [PyPi](https://pypi.org/project/mjlab) (📥 120K / month):
	```
	pip install mjlab
	```
</details>
...
- [GitHub]() (👨‍💻 47 · 📦 110):
	...
	```
- [PyPi](https://pypi.org/project/metaworld) (📥 34K / month):
	```
...
- [GitHub]() (👨‍💻 23 · 📦 3.2K):
	...
	```
- [PyPi](https://pypi.org/project/pyrender) (📥 920K / month):
	```
