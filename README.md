...
- [GitLab](https://gitlab.com/sdurobotics/RobWork) (🔀 46 · 📋 110 - 15% open · ⏱️ 07.04.2016):
...
- [GitHub]() (👨‍💻 20 · 📦 9):
	...
	```
- [PyPi](https://pypi.org/project/pyrobosim) (📥 850 / month):
	```
...
<details><summary><b><a href="https://www.flightgear.org/">Flightgear</a></b> (🥇8 ·  ⭐ 77 · 💤) - FlightGear open-source flight simulator [flightgear.org](https://www.flightgear.org). <code><a href="https://tldrlegal.com/search?q=gnu-gpl2">gnu-gpl2</a></code></summary>

- [GitLab](https://gitlab.com/flightgear/flightgear) (🔀 63 · 📋 620 - 38% open · ⏱️ 04.03.2015):
...
- [GitHub]() (👨‍💻 54):
	...
	```
- [PyPi](https://pypi.org/project/mjlab) (📥 130K / month):
	```
	pip install mjlab
	```
</details>
...
<details><summary><b><a href="https://jaxsim.readthedocs.io">jaxsim</a></b> (🥈6) - A differentiable physics engine and multibody dynamics library for control and robot learning. <code>Unlicensed</code></summary>
...
- [GitHub]() (👨‍💻 16 · 📦 4):
	...
	```
- [PyPi](https://pypi.org/project/jaxsim) (📥 380 / month):
	```
	pip install jaxsim
	```
...
- [GitHub]() (👨‍💻 23 · 📦 3.2K):
	...
	```
- [PyPi](https://pypi.org/project/pyrender) (📥 830K / month):
	```
...
- [GitHub]() (👨‍💻 58):
	...
	```
- [PyPi](https://pypi.org/project/highway-env) (📥 6.3K / month):
	```
